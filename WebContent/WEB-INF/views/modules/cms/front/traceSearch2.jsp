...
function traceSearch() {
	...
	if(!traceCode) {
		...
		$("iframe").attr('src',"http://hunan.project.agrisaas.com.cn/aptmp-trace/trace/index?traceNum=" + traceCode + "&from=groupmessage");
		$("#code1").html('<span class="code1" style="width:180px;height:180px;"></span>');
		var src = "http://hunan.project.agrisaas.com.cn/aptmp-trace/trace/index?traceNum=" + traceCode + "&from=groupmessage";
		jQuery('.code1').qrcode({
			render: "canvas", 
			width: 180,
			height: 180,
