	  ...
	  setting = {
		...
		callback:{
			...
			onClick:function(event, treeId, treeNode){
				//$("#gxcmsFrame", window.parent.document).attr("src",'${ctx}/cms/article/list?category.id='+treeNode.id);
				$("#gxcmsFrame", window.parent.document).attr("src",'${ctx}/cms/comment?category.id='+treeNode.id);
			}
		}
	};
