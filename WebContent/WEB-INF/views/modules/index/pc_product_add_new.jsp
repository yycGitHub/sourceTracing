	...
	<div id="step_demo" class="step-body" style="padding-top:30px;">
	    ...
	    <div class="step-content" align="center">
	        ...
	        <div class="step-list">
	        	...
	        	<div class="tab_btn_show">
	        		<input class="btn btn_primary" id="backBtn2" type="button" value="上一步"/>
	        ...
	        <div class="step-list">
		    	<div class="suCai17-content" align="center">
					...
					<div class="tab_btn_show">
						<input class="btn btn_primary" id="backBtn3" type="button" value="上一步"/>
				...
				$.get(url, param, function(res) {
					...
					if(res.code==0){
						//var index = layer.alert('操作成功', {icon: 1,title: "提示",yes:function(){
							...
							console.log("这是产品id吗？=="+res.bodyData.id);
							$step.nextStep();//下一步
						//}});
					}else{
						layer.alert(res.message, {icon: 2,title: "提示"});
	                		...
	                		if(len2>0){
		                		...
		                		if(mklx==1){	
				                	if(mkmc!='主模块'){
				                		...
				                		if(mkmc!='基本信息'){
				                			sxhtml+='&nbsp;&nbsp;<img src="${ctxStatic}/pcindex/images/up.png" title="上移模块" height="18px" width="18px" onclick="up(\''+mkid+'\')"/>&nbsp;&nbsp;<img src="${ctxStatic}/pcindex/images/down.png" title="下移模块" height="18px" width="18px" onclick="down(\''+mkid+'\')"/>';
				                		}
				                		sxhtml+='</span>'
				                		+'</h2>'
				                		...
				                		sxhtml+='</h2><div class="suCai17-side"><ul id=\"'+mkid+'\">';
				                	}
			                	}else if(mklx==2){
			                		sxhtml+='<span class="f_r" style="color: #27af59;padding-top:3px;font-size:12px;cursor:pointer">';
			                		sxhtml+='<img src="${ctxStatic}/pcindex/images/icon01.png" title="新增属性" height="18px" width="18px" onclick="addSx(\''+mkid+'\',1)"/>'
			                		+'&nbsp;&nbsp;<img src="${ctxStatic}/pcindex/images/up.png" title="上移模块" height="18px" width="18px" onclick="up(\''+mkid+'\')"/>&nbsp;&nbsp;<img src="${ctxStatic}/pcindex/images/down.png" title="下移模块" height="18px" width="18px" onclick="down(\''+mkid+'\')"/>'
			                		+'</span>'
			                		+'</h2>'
			                		+'<div class="suCai17-side">'
			                		+'<ul id=\"'+mkid+'\">';
