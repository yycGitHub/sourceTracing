...
<head>
    ...
    <link rel="stylesheet" href="editor-app/fonts/font-awesome/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="editor-app/libs/DataTables/datatables.min.css"/>
    <link rel="stylesheet" type="text/css" href="editor-app/libs/DataTables/buttons.dataTables.min.css"/>
    <link rel="stylesheet" type="text/css" href="editor-app/libs/css/base.css"/>
...
var appContextRoot='${pageContext.request.contextPath}/act';
	...
	<script src="editor-app/libs/js/base.js" type="text/javascript"></script>
	<script src="editor-app/libs/js/base-modal.js" type="text/javascript"></script>
	
	<script src="editor-app/libs/DataTables/datatables.min.js"></script>
	<script src="editor-app/libs/DataTables/dataTables.buttons.min.js"></script>
