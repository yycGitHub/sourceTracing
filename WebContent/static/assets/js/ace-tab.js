/**
*说明：与ace配套的在主页面使用的tab插件
*作者：黄枰凯
*更新时间：2016-4-15 16：37 完结 完全适应浏览器各种大小
**/
(function ($, window) {
    ...
    $.fn.aceaddtab = function (options) {
        ...
        var _loadContent = function () {
            ...
            if (_tabs.length == 1) {
                ...
                tabTitles += " <i class=\"menu-icon fa " + opt.icon + " bigger-110\"></i>&nbsp;";
                tabTitles += opt.title;
                //tabTitles += "<i class=\"light-red icon-remove bigger-110\"></i>";
                tabTitles += "</a>";
                //---------------------------------------------------
                tabTitles += "</li>";
                tabTitles += "</ul>"
                ...
                //区域的内容
                var tabContents = "<div class=\"tab-content\" style=\"padding: 0px 0px 0px 12px;\">";
                //循环体
            ...
            if ($("#" + htmlID + " > ul > li[class*='dropdown']").size() == 1) {
                ...
                listHtml += " <i class=\"menu-icon fa " + opt.icon + " bigger-110\"></i>&nbsp;";
                listHtml += opt.title;
                listHtml += "&nbsp;<i class=\"light-red icon-remove bigger-110\" style=\"cursor:pointer\"></i>";
                listHtml += "</a>";
                listHtml += "</li>";
                ...
                tabTitles += " <i class=\"menu-icon fa " + opt.icon + " bigger-110\"></i>&nbsp;";
                tabTitles += opt.title;
                tabTitles += "&nbsp;<i class=\"light-red icon-remove bigger-110\" style=\"cursor:pointer\"></i>";
                tabTitles += "</a>";
                //---------------------------------------------------
                tabTitles += "</li>";
            ...
            //---------------------------------------------------
            tabContents += "<div class=\"main-container\" id=\"main-container\"><div class=\"main-container-inner\">";
            tabContents += "<div class=\"breadcrumbs\" id=\"breadcrumbs\"><ul class=\"breadcrumb\"><li><i class=\"menu-icon fa " + opt.icon + " bigger-110\"></i>" +
            		//"<a href=\"#\">&nbsp;&nbsp;" + opt.pname +
            		"&nbsp;&nbsp;" + opt.pname +
            		//"&nbsp;</a></li><li><a href=\"#\">" + opt.name +
            		"&nbsp;</li><li>" + opt.name +
            		"</li>" +
            		"<li class=\"active\">" + opt.sname +
            		"</li>	" +
            		"</ul></div>";
            tabContents += "</div></div>";
            tabContents += "<iframe width=\"100%\" height=\"90%\" src=\"" + opt.url + "\" frameborder=\"0\" marginwidth=\"0\" marginheight=\"0\" scrolling=\"auto\"></iframe>";
            //---------------------------------------------------
            tabContents += "</div>"
        ...
        var _tabList = function () {
            ...
            if ($("#" + htmlID + " > ul").outerHeight(true) < 50) {
                ...
                for (var i = 0; i < tabs.length; i++) {
                    ...
                    tabTitles += " <i class=\"menu-icon fa " + tabs[i].icon + " bigger-110\"></i>&nbsp;";
            ...
            if ($("#" + htmlID + " > ul").outerHeight(true) > 50) {
                ...
                listTab += "<i class=\"icon-list bigger-110\" ></i>";
                listTab += "</a>";
                ...
                for (var i = 0; i < tabs.length; i++) {
                    if (i > showCount - 1) {
                        ...
                        listHtml += " <i class=\"menu-icon fa " + tabs[i].icon + " bigger-110\"></i>&nbsp;";
