...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String packageName = "com.surekam.modules";
		
		String moduleName = "traceproduct";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "TraceProduct";			// 类名，例：user
		String classAuthor = "ligm";		    // 类作者
		String functionName = "溯源产品管理";			// 功能名，例：用户
		String tableName = "t_trace_product";
