...
public class Category extends IncrementDataEntity<Category> {
	...
	private String isCommentAudit;	// 评论是否需要审核
	...
	@Transient
	public static void sortList(List<Category> list, List<Category> sourcelist, Integer parentId){
	...
	public String getIsCommentAudit() {
		return isCommentAudit;
	}

	public void setIsCommentAudit(String isCommentAudit) {
