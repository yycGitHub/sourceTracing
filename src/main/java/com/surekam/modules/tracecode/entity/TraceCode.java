...
public class TraceCode extends XGXTEntity<TraceCode> {
	
	private static final long serialVersionUID = 1L;
	private String id;//主键
	private String traceCode;//溯源码（打印时创建溯源码信息）
	private Integer serialNumber;//溯源码流水号
	...
	public String toString() {
		return "TraceCode [id=" + id + ", traceCode=" + traceCode + ", serialNumber=" + serialNumber + ", applyId="
				+ applyId + ", officeId=" + officeId + ", sysId=" + sysId + ", batchId=" + batchId + ", traceType="
				+ traceType + ", traceCount=" + traceCount + ", packingType=" + packType + ", antiFakeCode=" + antiFakeCode
				+ ", status=" + status + ", printDate=" + printDate + ", activationDate=" + activationDate
				+ ", activator=" + activator + ", batchCode=" + batchCode + ", productName=" + productName + "]";
	}
